    ...
    <div class="flex flex-wrap -m-4">
      <div class="p-4 lg:w-1/2 md:w-full">
        <div class="flex border-2 rounded-lg border-[#111827] bg-gray-50 p-8 sm:flex-row flex-col">
          ...
          <div class="flex-grow">
            <h2 class="text-gray-900 text-2xl title-font font-medium font-sor mb-3 hover:underline cursor-pointer">Feature 1</h2>
      ...
      <div class="p-4 lg:w-1/2 md:w-full">
        <div class="flex border-2 rounded-lg border-[#111827] bg-gray-50 p-8 sm:flex-row flex-col">
          ...
          <div class="flex-grow">
            <h2 class="text-gray-900 text-2xl font-sor title-font font-medium mb-3 hover:underline cursor-pointer">Feature 2</h2>
            <p class="leading-relaxed text-base font-normal">Lorem ipsum dolor sit amet consectetur doloribus eveniet! Doloremque voluptas iure magnam voluptatem! Veritatis adipisci unde quibusdam dolor quod quos blanditiis ratione iusto ducimus!</p>
          </div>
        </div>
      </div>
    </div>
